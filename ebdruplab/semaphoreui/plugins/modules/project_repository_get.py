...
DOCUMENTATION = r'''
---
module: project_repository_get
short_description: Retrieve a specific repository from a Semaphore project
version_added: "1.0.0"
description:
  - Fetches details of a single repository resource within a given Semaphore project.
options:
  host:
    description:
  ...
  project_id:
    description:
      - ID of the project containing the repository.
    type: int
    required: true
  repository_id:
    description:
...
- name: Dump repository
  debug:
    var: repository_data.repository
'''

RETURN = r'''
repository:
  description: Details of the requested repository.
  type: dict
  returned: success
status:
